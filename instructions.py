...
house = [
    ...
    ("You are about to knock when the door "
        f"opens and out steps a {current_beast}."),
...
cave = [
    ...
    (f"You discard your silly old dagger and "
        "take the {current_weapon} with you."),
...
fight_with_sword = [
    (f"As the {current_beast} moves to attack, "
        f"you bring our your {current_weapon}"),
    (f"The {current_weapon} shines brightly"
        "in your hand as you brace yourself for the attack."),
    (f"But the {current_beast} takes one look at your "
